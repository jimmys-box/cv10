...
const [equipe, setEquipe] = useState(equipe2)
    ...
    return (
        <>
            <div onClick={handleshowSolaires} className="ficheClientListOuterContainer">
            <div style={{ width: '20%' }}>
                    <p className='nomFicheClient' style={{ marginBottom: 0, textAlign: 'center' }}>{nomMagasin}</p>
                </div>
                <div style={{ width: '20%' }}>
                ...
                <div style={{ width: '20%' }}>
                    <p className='texteFicheClient'>{surfaceEnM}m²</p>
                </div>
            </div>
                        ...
                        <div className="formSection dFlex justifyCenter alignCenter flexColumn" >
                            ...
                            <div className="formSectionInner dFlex justifyBetween width500" >
                                <div className="formSectionChamp">
                                    ...
                                    <input disabled={disabledField} className="formSectionInput" type="number" pattern="[0-9]" onChange={(e) => { setSurfaceEnM(e.target.value) }} />
                                </div>
                                <div className="formSectionChamp">
